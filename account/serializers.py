...
from account.tasks import celery_send_confirmation_email, restore_p_mail
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        celery_send_confirmation_email(code, user.email)
        return user
...
class ForgotPasswordSerializer(serializers.Serializer):
    ...
    def send_code(self):
        ...
        user.save()
        restore_p_mail(user.activation_code, email, user.username)
